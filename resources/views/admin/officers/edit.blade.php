                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="user[name]" id="name"
                            ...
                            value="{{ old('user.name') ?? $officer->user->name }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="user[email]" id="email"
                            ...
                            value="{{ old('user.email') ?? $officer->user->email }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="user[phone_number]" id="phone_number"
                            ...
                            aria-describedby="phone_numberHelp" value="{{ old('user.phone_number') ?? $officer->user->phone_number }}">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="user[national_identification_number]" id="national_identification_number"
                            ...
                            value="{{ old('user.national_identification_number') ?? $officer->user->national_identification_number }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="officer[station_id]" id="stationId"
                            ...
                            <option {{ (old('officer.station_id') ?? $officer->station_id) ? 'selected' : '' }} value="{{ $station->id }}">{{ $station->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="officer[officer_number]" id="officer_number"
                            ...
                            aria-describedby="officer_numberHelp" value="{{ old('officer.officer_number') ?? $officer->officer_number }}">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="custom-control custom-checkbox mb-3">
                            <input type="checkbox" name="officer[ocs]" class="custom-control-input" id="ocsCheckBox" {{ (old('officer.ocs') ?? $officer->ocs) ? 'checked' : '' }}>
                            <label class="custom-control-label" for="ocsCheckBox">Officer Commanding Police Station
                                (OCS)</label>
                        </div>
                    </div>
                </div>
